...
const passportStrategy_1 = __importDefault(require("../../infrastructure/helper/passportStrategy"));
...
router.get('/google', passportStrategy_1.default.authenticate('google', {
    scope: ['profile', 'email'],
    session: false,
    failureRedirect: "/google/failure"
}));
router.get('/google/callback', passportStrategy_1.default.authenticate('google', { session: false, failureRedirect: '/google/failure' }), (0, google_controller_1.LoginUserInGoogleController)(auth_repo_1.AuthRepo));
