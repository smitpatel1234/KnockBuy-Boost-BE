...
exports.DiscountRepo = {
    AlreadyApplied: async (em, discount_id, user_id) => {
        const order = await em.getRepository(order_1.Order).findOne({ where: { discount: { discount_id: discount_id }, user: { user_id: user_id } } });
        return !!order;
    },
